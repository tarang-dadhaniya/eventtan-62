      ...
      >
        ...
        <div class="flex-shrink-0 px-8 py-8 border-b border-[#CED4DA]">
          <div class="flex items-center justify-between">
            <h2 class="text-2xl font-medium text-[#3F4254]">
              About Detail
            </h2>
            <button
              type="button"
        ...
        <form class="flex-1 flex flex-col min-h-0" (ngSubmit)="onSubmit()">
          ...
          <div class="flex-1 overflow-y-auto px-8 py-8 min-h-0 space-y-8">
            ...
            <div>
              ...
              <div class="border border-[#CED4DA] rounded overflow-hidden">
                <!-- Rich Text Toolbar -->
                <div class="bg-white border-b border-[#CED4DA] p-2 flex flex-wrap gap-1 items-center overflow-x-auto">
                  <!-- Undo/Redo -->
                  <button type="button" class="p-2 hover:bg-[#F0F0F0] rounded text-[#212529] transition-colors">
                  ...
                  <!-- Text Style Dropdown -->
                  <button type="button" class="px-3 py-2 hover:bg-[#F0F0F0] rounded text-[#212529] text-sm font-medium flex items-center gap-1 transition-colors">
                  ...
                  <!-- Format Buttons -->
                  <button type="button" class="p-2 hover:bg-[#F0F0F0] rounded text-[#212529] transition-colors" title="Bold">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button type="button" class="p-2 hover:bg-[#F0F0F0] rounded text-[#212529] transition-colors" title="Italic">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button type="button" class="p-2 hover:bg-[#F0F0F0] rounded text-[#212529] transition-colors" title="Underline">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <!-- Modal Footer - Fixed -->
          <div class="flex-shrink-0 px-8 py-6 border-t border-[#CED4DA] flex justify-end gap-3">
            <button
              type="button"
              (click)="onCancel()"
